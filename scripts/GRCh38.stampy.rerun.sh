...
#SBATCH --output=/home/arsth/scratch/PGX_DENOVO/STAMPY_PIPELINE/log/%a.${ind}.GRCh38.stampy.rerun.out
#SBATCH --error=/home/arsth/scratch/PGX_DENOVO/STAMPY_PIPELINE/log/%a.${ind}.GRCh38.stampy.rerun.err
#SBATCH -D /home/arsth/scratch/PGX_DENOVO/STAMPY_PIPELINE/
#SBATCH --mail-type ALL 
#SBATCH --mail-user alex.richard-st-hilaire@umontreal.ca

module load samtools/1.5
for SLURM_ARRAY_TASK_ID in {1..100} ; do
    ...
    bamfile=${path_project}/PGX_DENOVO/STAMPY_PIPELINE/GRCh38/${ind}.GRCh38.${SLURM_ARRAY_TASK_ID}.stampy.bam
    path_rawdata=${path_project}/PGX_DENOVO/data/Quartet1301
    ...
    then
        ...
        outsam=${path_project}/PGX_DENOVO/STAMPY_PIPELINE/GRCh38/${ind}.GRCh38.${SLURM_ARRAY_TASK_ID}.stampy.sam
	#remove previous failed SAM file (if present) or stampy will not run
        ...
        echo "Stampy job ${SGE_TASK_ID} is complete, will not rerun" 1>&2
